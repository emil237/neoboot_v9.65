...
sleep 4;
echo " SUPPORTED BY  >>>>  Lenuxsat  " 
sleep 6;
echo "***********************************************************************"
echo " download and install plugin imagedownloder "
echo "***********************************************************************"

cd /tmp
set -e 
wget "https://raw.githubusercontent.com/emilnabil/neoboot_v9.58/main/ImageDownloader.tar.gz"
wait
tar -xzf ImageDownloader.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/ImageDownloader.tar.gz

wait                                                                               
echo "**********************************************************************************"
cd /tmp
set -e 
wget "https://raw.githubusercontent.com/emil237/neoboot_v9.65/main/enigma2-plugin-extensions-neoboot-$NEOBOOT-by-linuxsat_emil-nabil_all.ipk"
wait
opkg install enigma2-plugin-extensions-neoboot-$NEOBOOT-by-linuxsat_emil-nabil_all.ipk
cd ..
set +e
rm -f /tmp/enigma2-plugin-extensions-neoboot-$NEOBOOT-by-linuxsat_emil-nabil_all.ipk
